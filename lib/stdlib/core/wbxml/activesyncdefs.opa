...
module ActiveSyncDefs {
  ...
  tag_code_space = [
    ...
    (2,[(0x05,"Attachment"), //2.5, 12.0, 12.1 and 14.0
    ...
    (4,[(0x05,"Timezone"), //2.5, 12.0, 12.1 and 14.0
    ...
    (9,[(0x05,"Body"), //2.5, but is in code page 17 in ActiveSync versions 12.0, 12.1, and 14.0
    ...
    (0xe,[(0x05,"Provision"), //2.5, 12.0, 12.1 and 14.0
    ...
    (0xf,[(0x05,"Search"), //12.0, 12.1 and 14.0
    ...
    (0x12,[(0x05,"Settings"), //12.0, 12.1 and 14.0
    ...
    (0x18,[(0x05,"RightsManagementSupport"),
